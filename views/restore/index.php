...
<div class="alert alert-info" role="alert">
    ...
    <span><?= \Yii::t('tickets', 'Do you want to restore a file? Then please visit {link}.', [
...
<?= ListView::widget([
    ...
    'itemView' => '_item',
    'emptyText' => \Yii::t('tickets', 'No restores found.'),
...
Modal::begin([
    'id' => 'restoreLogModal',
    'header' => '<h4>' . \Yii::t('tickets', 'Restore Log') . '</h4>',
